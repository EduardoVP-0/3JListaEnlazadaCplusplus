...
void agregarNodo(Nodo*& cabeza, int valor) {//CABEZA ES HEAD EN IMAGEN
	Nodo* nuevoNodo = new Nodo; //Creando el apuntador hacia el nuevo nodo
	nuevoNodo->dato = valor;
	nuevoNodo->siguiente = nullptr; //DUDA
	if (cabeza == nullptr) {
		cabeza = nuevoNodo;
	}
	else {
...
int main() {
	...
	int tamanoLista;
	cout << "Ingrese la cantida de elementos que desea agregar a la lista: ";
	cin >> tamanoLista;
